...
namespace statusengine {
    ...
    class NagiosProcessDataSerializer : public ObjectSerializer<const nebstruct_process_data&> {
    public:
        explicit NagiosProcessDataSerializer(INebmodule &neb) : ObjectSerializer(neb) {}
    ...
    class NagiosServiceCheckDataSerializer : public ObjectSerializer<const nebstruct_service_check_data&> {
    public:
        explicit NagiosServiceCheckDataSerializer(INebmodule &neb) : ObjectSerializer(neb), macros(get_global_macros()) {
        }
    ...
    protected:
        void Serializer(const nebstruct_service_check_data &serviceCheckData) override {
            ...
            try{
                ...
                get_raw_command_line_r(macros, nag_service->check_command_ptr, nag_service->check_command,
                                    &raw_command, 0);
    ...
    class NagiosAcknowledgementDataSerializer : public ObjectSerializer<const nebstruct_acknowledgement_data&> {
    public:
        explicit NagiosAcknowledgementDataSerializer(INebmodule &neb) : ObjectSerializer(neb) {}
    ...
    class NagiosCommentDataSerializer : public ObjectSerializer<const nebstruct_comment_data&> {
    public:
        explicit NagiosCommentDataSerializer(INebmodule &neb) : ObjectSerializer(neb) {}
    ...
    class NagiosContactNotificationDataSerializer : public ObjectSerializer<const nebstruct_contact_notification_data&> {
    public:
        explicit NagiosContactNotificationDataSerializer(INebmodule &neb) : ObjectSerializer(neb) {}
    ...
    class NagiosContactNotificationMethodDataSerializer : public ObjectSerializer<const nebstruct_contact_notification_method_data&> {
    public:
        explicit NagiosContactNotificationMethodDataSerializer(INebmodule &neb) : ObjectSerializer(neb) {}

    protected:
        void Serializer(const nebstruct_contact_notification_method_data &data) override {
            SetData("type", data.type);
            SetData("flags", data.flags);
            SetData("attr", data.attr);
            SetData("timestamp", data.timestamp.tv_sec);
    ...
    class NagiosContactStatusDataSerializer : public ObjectSerializer<const nebstruct_contact_status_data&> {
    public:
        explicit NagiosContactStatusDataSerializer(INebmodule &neb) : ObjectSerializer(neb) {}
    ...
    protected:
        void Serializer(const nebstruct_contact_status_data &data) override {
            ...
            SetData("host_notifications_enabled", tmpContact->host_notifications_enabled);
            SetData("service_notifications_enabled", tmpContact->service_notifications_enabled);
            SetData("last_host_notification", tmpContact->last_host_notification);
            SetData("last_service_notification", tmpContact->last_service_notification);
            SetData("modified_attributes", tmpContact->modified_attributes);
            SetData("modified_host_attributes", tmpContact->modified_host_attributes);
            SetData("modified_service_attributes", tmpContact->modified_service_attributes);
            EndChildObject();
        }
    };

    class NagiosDowntimeDataSerializer : public ObjectSerializer<const nebstruct_downtime_data&> {
    public:
        explicit NagiosDowntimeDataSerializer(INebmodule &neb) : ObjectSerializer(neb) {}
    ...
    class NagiosEventHandlerDataSerializer : public ObjectSerializer<const nebstruct_event_handler_data&> {
    public:
        explicit NagiosEventHandlerDataSerializer(INebmodule &neb) : ObjectSerializer(neb) {}
    ...
    class NagiosExternalCommandDataSerializer : public ObjectSerializer<const nebstruct_external_command_data&> {
    public:
        explicit NagiosExternalCommandDataSerializer(INebmodule &neb) : ObjectSerializer(neb) {}
    ...
    class NagiosFlappingDataSerializer : public ObjectSerializer<const nebstruct_flapping_data&> {
    public:
        explicit NagiosFlappingDataSerializer(INebmodule &neb) : ObjectSerializer(neb) {}
    ...
    protected:
        void Serializer(const nebstruct_flapping_data &data) override {
            ...
            SetData("comment_id", data.comment_id);
            SetData("comment_entry_time", (tmpComment == nullptr ? 0 : tmpComment->entry_time));
    ...
    class NagiosHostCheckDataSerializer : public ObjectSerializer<const nebstruct_host_check_data&> {
    public:
        explicit NagiosHostCheckDataSerializer(INebmodule &neb) : ObjectSerializer(neb), macros(get_global_macros()) {
        }
    ...
    protected:
        void Serializer(const nebstruct_host_check_data &data) override {
            ...
            try{
                ...
                char *raw_command = nullptr;
                get_raw_command_line_r(macros, nag_host->check_command_ptr, nag_host->check_command, &raw_command, 0);
                if (raw_command == nullptr) {
                    command = "";
                } else {
                    command = std::string(raw_command);
    ...
    class NagiosHostStatusDataSerializer : public ObjectSerializer<const nebstruct_host_status_data&> {
    public:
        explicit NagiosHostStatusDataSerializer(INebmodule &neb) : ObjectSerializer(neb), hostSerializer(neb) {}
    ...
    protected:
        void Serializer(const nebstruct_host_status_data &data) override {
            ...
            InsertJsonObject("hoststatus", hostSerializer.ToJson(*(reinterpret_cast<host *>(data.object_ptr))));
        }
    ...
    class NagiosLogDataSerializer : public ObjectSerializer<const nebstruct_log_data&> {
    public:
    ...
    class NagiosNotificationDataSerializer : public ObjectSerializer<const nebstruct_notification_data&> {
    public:
        explicit NagiosNotificationDataSerializer(INebmodule &neb) : ObjectSerializer(neb) {}
    ...
    class NagiosProgramStatusDataSerializer : public ObjectSerializer<const nebstruct_program_status_data&> {
    public:
        explicit NagiosProgramStatusDataSerializer(INebmodule &neb) : ObjectSerializer(neb) {}
    ...
    protected:
        void Serializer(const nebstruct_program_status_data &data) override {
            ...
            SetData("global_service_event_handler", data.global_service_event_handler);
            ...
            SetData("notifications_enabled", data.notifications_enabled);
            SetData("active_service_checks_enabled", data.active_service_checks_enabled);
            SetData("passive_service_checks_enabled", data.passive_service_checks_enabled);
            SetData("active_host_checks_enabled", data.active_host_checks_enabled);
            SetData("passive_host_checks_enabled", data.passive_host_checks_enabled);
            ...
            SetData("modified_service_attributes", data.modified_service_attributes);
            EndChildObject();
        }
    };

    class NagiosServiceCheckPerfDataSerializer : public ObjectSerializer<const nebstruct_service_check_data&> {
    public:
        explicit NagiosServiceCheckPerfDataSerializer(INebmodule &neb) : ObjectSerializer(neb) {}
    ...
    class NagiosServiceStatusDataSerializer : public ObjectSerializer<const nebstruct_service_status_data&> {
    public:
        explicit NagiosServiceStatusDataSerializer(INebmodule &neb) : ObjectSerializer(neb), serviceSerializer(neb) {}

    protected:
        void Serializer(const nebstruct_service_status_data &serviceStatusData) override {
    ...
    class NagiosStateChangeDataSerializer : public ObjectSerializer<const nebstruct_statechange_data&> {
    public:
        explicit NagiosStateChangeDataSerializer(INebmodule &neb) : ObjectSerializer(neb) {}

    protected:
        void Serializer(const nebstruct_statechange_data &stateChangeData) override {
    ...
    class NagiosSystemCommandDataSerializer : public ObjectSerializer<const nebstruct_system_command_data&> {
    public:
        explicit NagiosSystemCommandDataSerializer(INebmodule &neb) : ObjectSerializer(neb) {}

    protected:
        void Serializer(const nebstruct_system_command_data &systemCommandData) override {
