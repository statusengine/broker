...
namespace statusengine {
    ...
    NagiosEventHandlerData::NagiosEventHandlerData(const nebstruct_event_handler_data *eventHandlerData) {
        ...
        SetData<>("service_description", eventHandlerData->service_description, eventhandler);
        ...
        SetData<>("early_timeout", eventHandlerData->early_timeout, eventhandler);
        SetData<>("return_code", eventHandlerData->return_code, eventhandler);
        SetData<>("execution_time", eventHandlerData->execution_time, eventhandler);
        SetData<>("start_time", eventHandlerData->start_time.tv_sec, eventhandler);
