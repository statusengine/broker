...
namespace statusengine {
    ...
    NagiosContactNotificationData::NagiosContactNotificationData(
        ...
        SetData<>("host_name", contactNotificationData->host_name,
        ...
        SetData<>("ack_author", contactNotificationData->ack_author,
                  contactnotificationdata);
        SetData<>("ack_data", contactNotificationData->ack_data,
                  contactnotificationdata);
        SetData<>("contact_name", contactNotificationData->contact_name,
                  contactnotificationdata);
        SetData<>("state", contactNotificationData->state,
                  contactnotificationdata);
        SetData<>("reason_type", contactNotificationData->reason_type,
                  contactnotificationdata);
        SetData<>("end_time", contactNotificationData->end_time.tv_sec,
                  contactnotificationdata);
        SetData<>("start_time", contactNotificationData->start_time.tv_sec,
                  contactnotificationdata);
        SetData<>("notification_type",
                  contactNotificationData->notification_type,
                  contactnotificationdata);
